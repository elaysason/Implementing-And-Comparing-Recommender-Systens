...
def main():
    ...
    baseline_recommender = learners.BaselineRecommender(train)
    print('Baseline Recommender: ' + str(baseline_recommender.rmse(test)))
    neighborhood_recommender = learners.NeighborhoodRecommender(train)
    print('Neighborhood Recommender: ' + str((neighborhood_recommender.rmse(test))))
    ls_recommender = learners.LSRecommender(train)
    ls_recommender.solve_ls()
    print('LS Recommender: '+str(ls_recommender.rmse(test)))
